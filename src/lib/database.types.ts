...
export type UserStatus = DbEnums['user_status'];

export type NewUserProfile = DbTables['user_profiles']['Insert'];
export type UpdateUserProfile = DbTables['user_profiles']['Update'];
